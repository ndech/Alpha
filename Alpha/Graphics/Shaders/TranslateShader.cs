...
namespace Alpha.Graphics.Shaders
{
    class TranslateShader : IDisposable
    {
        ...
        private const string VertexShaderFileName = @"Data/Shaders/Translate.vs";
        private const string PixelShaderFileName = @"Data/Shaders/Translate.ps";
        ...
        SharpDX.Direct3D11.Buffer ConstantTranslationBuffer { get; set; }
        SamplerState SamplerState { get; set; }

        public TranslateShader(Device device)
        {
            ...
            ConstantTranslationBuffer = new SharpDX.Direct3D11.Buffer(device, translateBufferDesc);
