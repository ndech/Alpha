...
namespace Alpha.UI.Screens
{
    class MenuScreen : Screen
    {
            ...
            : base(game, "menu_screen", true)
        {
            ...
            panel.Register(_provincesButton = new Button(game, "menu_load", new UniRectangle(0.05f, 125, 0.9f, 40), "Provinces"));
            ...
            Register(new Tooltip(game, "provinces_tooltip", _provincesButton, 1d, "Show the provinces details"));
